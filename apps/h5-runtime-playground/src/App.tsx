...
const sampleSchema = createLowcodePageSchema({
  ...
  nodes: [
    ...
    },
    {
      ...
      materialVersion: "0.1.0",
      props: {
        text: "React H5 基础链接示例",
        subtitle: "轻量入口只提供普通 H5 链接和安全点击事件。",
        prefixText: "链接",
        linkUrl: "/activity/react-h5-guide",
        targetBlank: false,
        showArrow: true,
        arrowText: "›",
        variant: "card",
      ...
      events: {
        onClick: { actionId: "track_basic_link_click" },
      },
    },
    {
      id: "node_basic_alert",
      ...
      materialVersion: "0.1.0",
      props: {
        title: "React H5 基础提示示例",
        content: "静态提示只负责展示页面反馈、注意事项或风险说明，真实业务错误码和消息中心由宿主系统承接。",
        badgeText: "提示",
        actionText: "记录提示点击",
        tone: "info",
        variant: "outline",
      ...
      events: {
        onActionClick: { actionId: "track_basic_alert_action" },
      },
    },
    {
      id: "node_basic_state_block",
      componentName: "BasicStateBlock",
      materialVersion: "0.1.0",
      props: {
        state: "success",
        title: "React H5 基础状态块示例",
        description: "状态块用于静态空态、加载、错误和成功反馈，远程状态流仍由宿主协议承接。",
        actionText: "记录状态点击",
        showIcon: true,
        showAction: true,
        iconText: "✓",
      ...
      events: {
        onActionClick: { actionId: "track_basic_state_block_click" },
      },
    },
    {
      id: "node_basic_progress",
      componentName: "BasicProgress",
      materialVersion: "0.1.0",
      props: {
        title: "React H5 基础进度条示例",
        description: "进度条用于静态达成率和完成度展示，真实远程进度仍由数据源或业务物料承接。",
        value: 72,
        max: 100,
        valueSuffix: "%",
        showValue: true,
    ...
    {
      id: "node_basic_metric",
      componentName: "BasicMetric",
      materialVersion: "0.1.0",
      props: {
        label: "React H5 基础指标示例",
        value: "1280",
        suffix: "人",
        helperText: "指标物料用于静态数字展示，真实统计仍由数据源或业务物料承接。",
        tone: "brand",
        variant: "card",
        align: "left",
        wrapperBackgroundColor: "#f3f4f6",
    ...
    {
      id: "node_basic_metric_grid",
      componentName: "BasicMetricGrid",
      materialVersion: "0.1.0",
      props: {
        title: "React H5 基础指标组示例",
        description: "指标组用于静态摘要展示，真实统计仍由数据源或业务物料承接。",
        items: [
    ...
    },
    {
      ...
      events: {
        onSubmit: { actionId: "track_basic_form_submit" },
      },
      children: [
        {
          id: "node_basic_form_input",
          componentName: "BasicInput",
          materialVersion: "0.1.0",
          props: {
            label: "表单内输入框",
            placeholder: "请输入昵称",
            helperText: "必填。提交表单时会携带当前昵称字段。",
            type: "text",
            required: true,
            requiredMessage: "请填写表单内输入框",
        ...
        {
          id: "node_basic_form_checkbox",
          componentName: "BasicCheckbox",
          materialVersion: "0.1.0",
          props: {
            label: "同意接收活动通知",
            helperText: "必填。提交表单时会携带当前勾选状态。",
            defaultChecked: false,
            required: true,
            requiredMessage: "请确认同意接收活动通知",
            wrapperBackgroundColor: "transparent",
            labelColor: "#111827",
            helperColor: "#64748b",
            checkedColor: "#0f766e",
    ...
    },
    {
      ...
      materialVersion: "0.1.0",
      props: {
        title: "React H5 基础列表示例",
        subtitle: "静态内容列表适合承载步骤、卖点、注意事项或 FAQ 摘要。",
        marker: "badge",
        items: [
          {
            id: "h5_list_1",
            title: "组件保持通用",
            description: "列表项只包含标题、说明、标签和右侧信息，不绑定商品、优惠券或活动接口。",
            badgeText: "通用",
            metaText: "基础层",
          },
          {
            id: "h5_list_2",
            title: "事件保持安全",
            description: "点击列表项只触发 onItemClick action，由宿主决定埋点或跳转。",
            badgeText: "事件",
            metaText: "可选",
          },
          {
            id: "h5_list_3",
            title: "样式保持可配置",
            description: "运营可以配置背景、圆角、间距、标记样式和文本颜色。",
            badgeText: "样式",
            metaText: "可调",
          },
        ],
      ...
      events: {
        onItemClick: { actionId: "track_basic_list_item_click" },
      },
    },
    {
      id: "node_basic_accordion",
      componentName: "BasicAccordion",
      materialVersion: "0.1.0",
      props: {
        title: "React H5 基础折叠面板示例",
        subtitle: "静态折叠内容只负责展示和本地展开收起。",
        mode: "single",
        icon: "chevron",
        ...
        items: [
          {
            id: "h5_accordion_1",
            title: "基础层负责什么？",
            content: "基础折叠面板只负责静态内容、展开收起、样式配置和安全 toggle 事件。",
            badgeText: "Q1",
          },
          {
            id: "h5_accordion_2",
            title: "业务 FAQ 放在哪里？",
            content: "远程 FAQ、活动规则接口、内容审核和权限策略应由数据源协议、业务物料或宿主系统承接。",
            badgeText: "Q2",
          },
          {
            id: "h5_accordion_3",
            title: "能否用于普通说明？",
            content: "可以。运营可以把规则摘要、注意事项、售后说明或页面说明配置成静态折叠项。",
            badgeText: "Q3",
          },
        ],
        backgroundColor: "#f3f4f6",
      ...
      events: {
        onItemToggle: { actionId: "track_basic_accordion_toggle" },
      },
    },
    {
      id: "node_basic_timeline",
      componentName: "BasicTimeline",
      materialVersion: "0.1.0",
      props: {
        title: "React H5 基础时间线示例",
        subtitle: "静态时间线用于展示流程步骤，不请求活动进度接口。",
        marker: "badge",
        showTime: true,
        showConnector: true,
        items: [
          ...
          },
          {
            id: "h5_timeline_2",
            title: "编辑页面内容",
            description: "运营配置标题、说明、节点和样式，不接业务状态模型。",
            timeText: "阶段二",
            badgeText: "Doing",
            status: "active",
          },
          {
            id: "h5_timeline_3",
            title: "提交发布检查",
            description: "发布、审批和埋点由宿主 action 或外部平台承接。",
            timeText: "阶段三",
            badgeText: "Todo",
            status: "pending",
          },
      ...
      events: {
        onItemClick: { actionId: "track_basic_timeline_item_click" },
      },
    },
    {
      id: "node_basic_text",
    ...
    {
      id: "node_grid_container",
      componentName: "GridContainer",
      materialVersion: "0.1.0",
      props: {
        title: "React H5 网格容器示例",
        subtitle: "React H5 runtime 使用同一 Page Schema children 渲染网格布局。",
        columns: 2,
        backgroundColor: "#ffffff",
        padding: 12,
        marginY: 12,
    ...
    },
    {
      ...
      props: {
        ...
        badgeText: "VIDEO",
        title: "React H5 视频示例",
        description: "React H5 runtime 渲染基础视频物料，播放事件可绑定安全 action。",
        ratio: "16 / 9",
        radius: 12,
        controls: true,
        autoPlay: false,
      ...
      events: {
        onPlay: { actionId: "track_basic_video_play" },
      },
    },
    {
      id: "node_basic_modal",
  ...
  actions: [
    ...
    {
      id: "track_basic_link_click",
      type: "tracking.click",
      params: {
        eventName: "basic_link_click",
      },
    },
    {
      id: "track_basic_alert_action",
      type: "tracking.click",
      params: {
        eventName: "basic_alert_action",
      },
    },
    {
      id: "track_basic_state_block_click",
      type: "tracking.click",
      params: {
        eventName: "basic_state_block_click",
      },
    },
    {
    ...
    {
      id: "track_basic_form_submit",
      type: "tracking.click",
      params: {
        eventName: "basic_form_submit",
      },
    },
    {
      id: "track_basic_list_item_click",
      type: "tracking.click",
      params: {
        eventName: "basic_list_item_click",
      },
    },
    {
      id: "track_basic_accordion_toggle",
      type: "tracking.click",
      params: {
        eventName: "basic_accordion_toggle",
      },
    },
    {
      id: "track_basic_timeline_item_click",
      type: "tracking.click",
      params: {
        eventName: "basic_timeline_item_click",
      },
    },
    {
