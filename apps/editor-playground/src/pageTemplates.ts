...
export const pageTemplates: PageTemplate[] = [
  {
    ...
    schema: createLowcodePageSchema({
      ...
      nodes: [
        ...
        {
          id: "summer_basic_state_block",
          componentName: "BasicStateBlock",
          materialVersion: "0.1.0",
          props: {
            state: "empty",
            title: "基础状态块示例",
            description: "适合展示空态、加载、错误或成功反馈，不接远程状态协议。",
            actionText: "刷新状态",
            showIcon: true,
            showAction: true,
            iconText: "○",
        ...
        {
          id: "summer_basic_progress",
          componentName: "BasicProgress",
          materialVersion: "0.1.0",
          props: {
            title: "基础进度条示例",
            description: "适合展示静态达成率、配置完成度或活动阶段进度，不接远程进度协议。",
            value: 72,
            max: 100,
            valueSuffix: "%",
            showValue: true,
        ...
        },
        {
          ...
          props: {
            ...
            value: "1280",
            suffix: "人",
            helperText: "适合展示静态人数、销量、库存或配置摘要，不接远程统计协议。",
            tone: "brand",
            variant: "card",
            align: "left",
            wrapperBackgroundColor: "#f3f4f6",
        ...
        {
          id: "summer_basic_metric_grid",
          componentName: "BasicMetricGrid",
          materialVersion: "0.1.0",
          props: {
            title: "基础指标组示例",
            description: "适合展示多项静态指标摘要，不接远程统计或实时刷新协议。",
            items: [
