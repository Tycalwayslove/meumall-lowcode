...
| 日期 | 提交 | 说明 |
| --- | --- | --- |
| 2026-08-01 | `本次提交` | 新增 React/Vue H5 runtime primitives 公开包，并让 materials 包从 primitives 包组合低代码物料。 |
