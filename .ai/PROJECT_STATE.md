...
- 当前发布检查、交付摘要、Schema 文件导入导出、版本差异、Schema 片段预览、模板摘要、模板预览派生和页面起步命令已沉淀到 editor API，发布链路和自动保存已抽象出部分本地持久化状态，但仍使用 localStorage mock，尚未切换真实 Java HTTP client、服务端草稿自动保存、服务端发布校验、审批和审计。
...
| 2026-08-01 | 本提交 | 沉淀 editor Schema 文件 API。 |
