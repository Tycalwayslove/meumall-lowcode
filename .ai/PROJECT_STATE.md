...
| 日期 | 提交 | 说明 |
| --- | --- | --- |
| 2026-08-01 | 待提交 | 新增 editor 物料分层总览和基础能力族 profile API，并接入 Vue3 物料面板与 smoke。 |
