...
- Java 配置平台 API 仍为前端草案，待 Java 配置平台负责人确认响应包装、鉴权、审批、服务端发布校验和分页。
...
| 2026-07-31 | 本提交 | 增强 Vue3 编辑器发布前检查清单。 |
