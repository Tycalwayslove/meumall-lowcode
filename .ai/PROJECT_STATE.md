...
- 当前发布检查、交付摘要、版本差异和 Schema 片段预览已沉淀到 editor API，发布链路和自动保存已抽象出部分本地持久化状态，但仍使用 localStorage mock，尚未切换真实 Java HTTP client、服务端草稿自动保存、服务端发布校验、审批和审计。
...
| 2026-08-01 | `本提交` | 沉淀编辑器版本差异和 Schema 摘要 API。 |
